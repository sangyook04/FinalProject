				...
				<div class="content">
					...
					<div class="studentMod">
						<form role="form" name="studentMod"
							action="/student/studentInfoMod" id="ModForm" method="post">
							<input type="hidden" name="${_csrf.parameterName }"
								value="${_csrf.token }">
							<div class="textInputEx">
								아이디: <input type="text" name="stuId" value="${stuMyInfo.stuId }"
									readonly="readonly">
							</div>
							<div class="textInput">
							...
							<div class="textInputEx">
								이름: <input type="text" name="stuName"
									value="${stuMyInfo.stuName }">
							</div>
							<div class="textInputEx">
								성별: <input type="text" name="stuGender"
									value="${stuMyInfo.stuGender}" readonly="readonly">
							</div>
							<div class="textInput">
